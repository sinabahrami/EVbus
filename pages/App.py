...
def main():
    ...
    agencies = ["BATA (Traverse City)", "CATA (Lansing)", "DDOT (Detroit)", "Gainesville", "MAX (Holland)", "METRO (Kalamazoo)", "Palm Beach", "Smart (Detroit)", "The Rapid (Grand Rapids)", "TheRide (Ann Arbor-Ypsilanti)", "UMich"]
    ...
    with st.sidebar:
        ...
        elif selected_agency=="Palm Beach":
        ...
        elif selected_agency=="Gainesville":
