...
def generate_route_charger_maps(shapes_df, trips_df, proposed_locations_df, wireless_track_shape_df, center_lat, center_lon):
    ...
    def plot_map(plot_routes=True, plot_chargers=True, plot_wireless=True):
        ...
        if plot_chargers and not gdf_chargers.empty:
            gdf_chargers.plot(ax=ax, color='blue', markersize=15, marker='x', label='Stationary Charger', zorder=3)
            ...
            for cluster_label, count in cluster_counts.items():
                ...
                x_mean = cluster_points.geometry.x.mean()+250
                y_mean = cluster_points.geometry.y.mean()+250
                # Add text showing number of points
                if count>1:
                    ax.text(x_mean, y_mean, f"{count}", color='black', fontsize=7, fontweight='bold',ha='center', va='center', zorder=4, bbox=dict(facecolor='white', edgecolor='none', alpha=0.7, pad=1))
            legend_handles.append(Line2D([0], [0], marker='x', color='blue', label='Stationary Charger',markerfacecolor='w', markersize=8))
...
class FullPageImage(Flowable):
    ...
    def draw(self):
        ...
        if self.licence:
            yb-=40
            self.canv.setFont("Times-Roman", 6)
            self.canv.setFillColorRGB(0, 0, 0)
...
def generate_transit_report(
    ...
    if inputs.get('specific_rorb')==1:
        intro_text +=(f"The application of filter resulted {inputs.get('maptrips')['route_id'].nunique()} routes. ")
    intro_text +=(    
...
def main():
    ...
    agencies = ["BATA (Traverse City)", "CATA (Lansing)", "DDOT (Detroit)", "MAX (Holland)", "METRO (Kalamazoo)", "PalmTran (Palm Beach)","Smart (Detroit)", "The Rapid (Grand Rapids)", "TheRide (Ann Arbor-Ypsilanti)", "UMich"]
    ...
    with st.sidebar:
        ...
        min_stoppage_time = st.number_input(label="Stationary Charging Setup Time [min]", min_value=0.0, value=5.0, step=0.1,help="Wireless chargers can start charging immediately, whereas plug-in chargers require a few minutes to connect and begin charging.")
        ...
        elif selected_agency=="PalmTran (Palm Beach)":
            feasible_block_options =['4604-v66', '4102-v66', '4101-v66', '304-v66', '301-v66', '309-v66', '305-v66', '319-v66', '4002-v66', '4008-v66', '4605-v66', '7303-v66', '321-v66', '4402-v66', '4004-v66', '4007-v66', '9501-v66', '9502-v66', '320-v66', '318-v66', '9503-v66', '9504-v66', '4403-v66', '306-v66', '119-v66', '7302-v66', '9402-v66', '317-v66', '6207-v66', '316-v66', '315-v66', '3103-v66', '8102-v66', '8101-v66', '6102-v66', '6204-v66', '6201-v66', '3102-v66', '3001-v66', '3002-v66', '113-v66', '6101-v66', '9202-v66', '116-v66', '118-v66', '4603-v66', '6002-v66', '6001-v66', '3105-v66', '9201-v66', '4307-v66', '4308-v66', '8001-v66', '8802-v66', '8801-v66', '9403-v66', '9401-v66', '3104-v66', '9103-v66', '2001-v66', '3101-v66', '307-v66', '6206-v66', '206-v66', '209-v66', '204-v66', '4303-v66', '7001-v66', '7002-v66', '6401-v66', '314-v66', '308-v66', '104-v66', '312-v66', '4401-v66', '3303-v66', '109-v66', '6203-v66', '6205-v66', '101-v66', '9101-v66', '6202-v66', '9102-v66', '3304-v66', '102-v66', '108-v66', '4304-v66', '6402-v66', '203-v66', '2003-v66', '4602-v66', '114-v66', '115-v66', '201-v66', '3302-v66', '2002-v66', '3301-v66', '313-v66', '112-v66', '110-v66', '7301-v66', '4601-v66', '303-v66', '402-v66', '4302-v66', '205-v66', '105-v66', '107-v66', '106-v66', '401-v66', '403-v66', '208-v66', '1002-v66', '1001-v66', '111-v66', '117-v66', '103-v66', '6301-v66', '6302-v66', '207-v66', '4306-v66', '4305-v66', '202-v66', '4704-v66', '310-v66', '302-v66', '311-v66', '4301-v66', '4702-v66', '4705-v66', '4701-v66', '4703-v66', '4005-v66', '4006-v66', '4001-v66', '4003-v66']
            feasible_route_options=[1, 2, 3, 4, 10, 20, 30, 31, 33, 40, 41, 43, 44, 46, 47, 60, 61, 62, 63, 64, 70, 71, 73, 80, 81, 88, 91, 92, 94, 95]
        elif selected_agency=="RTS (Gainesville)":
            feasible_block_options =[ 10011 ,  10012 ,  10013 ,  10031 ,  10051 ,  10052 ,  10053 ,  10061 ,  10071 ,  10081 ,  10082 ,  10091 ,  10093 ,  10101 ,  10111 ,  10121 ,  10122 ,  10132 ,  10151 ,  10152 ,  10161 ,  10171 ,  10201 ,  10203 ,  10231 ,  10261 ,  10262 ,  10331 ,  10333 ,  10341 ,  10351 ,  10353 ,  10372 ,  10431 ,  10432 ,  10521 ,  10522 ,  10523 ,  10751 ,  10752 ,  10753 ,  17111]
            feasible_route_options=[1, 3, 5, 6, 7, 8, 9, 10, 11, 12, 13, 15, 16, 17, 20, 21, 23, 26, 28, 33, 34, 35, 37, 38, 43, 46, 52, 75, 76, 78, 118, 122, 126, 127, 711]
            ...
            try:
                ...
                if flag_done==1 and toggle_value_cost==True:
                    if st.session_state.get("initial_num_infeasible_blocks") == 0:
                        ...
                        categories = [f"All Blocks Feasible with {round(st.session_state.get("additional_fleet_cost_no_ivc")/bus_cost,0)} Additional Buses & No Chargers","All Blocks Feasible with Selected Chargers"]
                        ...
                        categories = [f"All Blocks Feasible with {round(st.session_state.get('additional_fleet_cost_no_ivc')/bus_cost,0)} Additional Buses & No Chargers"]
                        Additional_fleet=np.array([st.session_state.get('additional_fleet_cost_no_ivc')])/1e6
                        Stationary_charger=np.array([0])/1e6
                        Bus_reciever=np.array([0])/1e6
                        dynamic_charger=np.array([0])/1e6
                    else:
                        categories = [f"All Blocks Feasible with {round(st.session_state.get('additional_fleet_cost_no_ivc')/bus_cost,0)} Additional Buses & No Chargers",f"Existing Fleet & Selected Chargers with {st.session_state.get('final_number_infeasible_blocks')} Infeasible Blocks", f"All Blocks Feasible with {round(st.session_state.get('additinal_fleet_cost')/bus_cost,0)} Additional Buses & Selected Chargers"]
                    ...
                    bar_width = 0.5
                    x = np.arange(len(categories))* (bar_width + 1.5)
